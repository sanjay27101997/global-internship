...
export default function EditAssetDialog(props) {
  ...
  useEffect(() => {
    ...
    if (props.open === true) {
      axios
        .post(API_URL + "progressive_quiz/get_single_record.php", {
          id: props.id,
        })
        .then(function (response) {
          ...
          if (response.data?.meta.error === false) {
            ...
            setQtype(response.data?.data?.QType ?? "");
            setQuestionType(response.data?.data?.QuestionType ?? "");
            setQuestionFile(response.data?.data?.Questionfile ?? "");
            setAnswerType(response.data?.data?.AnswerType ?? "");
            ...
            setOptionAFile(response.data?.data?.OptionA ?? "");
            setOptionBFile(response.data?.data?.OptionB ?? "");
            setOptionCFile(response.data?.data?.OptionC ?? "");
            setOptionDFile(response.data?.data?.OptionD ?? "");
          }
        })
  ...
  function submitAsset(e) {
    ...
    axios
      .post(API_URL + "progressive_quiz/edit_quiz.php", formData, config)
      .then(function (response) {
        if (response.data.meta.error === true) {
          setAddAssetMessage({
            type: "error",
                    ...
                    <div className="px-4 py-6 bg-gray-50 sm:px-6">
                      <div className="flex items-start justify-between space-x-3">
                        <div className="space-y-1">
                          ...
                          Edit Progressive Quizz
                          </Dialog.Title>
                          <p className="text-sm text-gray-500">
                            Get started by filling in the information below to
                            update Section Assessments.
                          </p>
                        </div>
...
<option value="10">Level 10</option>
    ...
    <source src={API_URL + questionfile}
            type="video/webm"/>
    ...
    Sorry, your browser doesn't support embedded videos.
                        ...
                        {questiontype === "Audio" ? (
                          ...
                          <div className="space-y-1 px-4 sm:space-y-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 sm:py-2">
                              ...
                              <div className="sm:col-span-2">
                              <audio controls>
  <source src={API_URL + questionfile} type="audio/mp3"/> 
  <source src={API_URL + questionfile} type="audio/mpeg"/>
Your browser does not support the audio element.
                        ...
                        <div className="space-y-1 px-4 sm:space-y-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 sm:py-2">
                          ...
                          <div className="sm:col-span-2">
                            <select
                              onChange={(e) => setNoOptions(e.target.value)}
                              value={nooptions}
                              id="role"
                              name="role"
                              className="block w-full shadow-sm sm:text-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md"
                        ...
                        {/* {(answertype === "Image" || answertype === "Audio") &&
                        nooptions === "2" ? (
                          <>
                            <div className="space-y-1 px-4 sm:space-y-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 sm:py-2">
                              <div>
                        ...
                        {answertype === "Audio" ? (
                          ...
                          <div className="space-y-1 px-4 sm:space-y-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 sm:py-2">
                              ...
                              <div className="sm:col-span-2">
                              <audio controls>
  <source src={API_URL + optionafile} type="audio/mp4"/> 
  <source src={API_URL + optionafile} type="audio/mpeg"/>
Your browser does not support the audio element.
</audio>
                              </div>
                            </div>
                        ...
                        {answertype === "Audio" ? (
                          ...
                          <div className="space-y-1 px-4 sm:space-y-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 sm:py-2">
                              ...
                              <div className="sm:col-span-2">
                              <audio controls>
  <source src={API_URL + optionbfile} type="audio/mp4"/> 
  <source src={API_URL + optionbfile} type="audio/mpeg"/>
Your browser does not support the audio element.
</audio>
                              </div>
                            </div>
                        ...
                        {answertype === "Audio" ? (
                          ...
                          <div className="space-y-1 px-4 sm:space-y-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 sm:py-2">
                              ...
                              <div className="sm:col-span-2">
                              <audio controls>
  <source src={API_URL + optioncfile} type="audio/mp3"/> 
  <source src={API_URL + optioncfile} type="audio/mpeg"/>
Your browser does not support the audio element.
</audio>
                              </div>
                            </div>
                        ...
                        {answertype === "Audio" ? (
                          ...
                          <div className="space-y-1 px-4 sm:space-y-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 sm:py-2">
                              ...
                              <div className="sm:col-span-2">
                              <audio controls>
  <source src={API_URL + optiondfile} type="audio/mp4"/> 
  <source src={API_URL + optiondfile} type="audio/mpeg"/>
Your browser does not support the audio element.
</audio>
                              </div>
                            </div>
                      ...
                      <div
                        id="blankdiv"
                        className={qtype === "blank" ? "block" : "hidden"}
                      >
                        <div className="space-y-1 px-4 sm:space-y-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 sm:py-2">
                          <div>
                            <label
    ...
    Sorry, your browser doesn't support embedded videos.
                        ...
                        {questiontype === "Audio" ? (
                          ...
                          <div className="space-y-1 px-4 sm:space-y-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 sm:py-2">
                              ...
                              <div className="sm:col-span-2">
                              <audio controls>
  <source src={API_URL + questionfile} type="audio/mp4"/> 
  <source src={API_URL + questionfile} type="audio/mpeg"/>
Your browser does not support the audio element.
</audio>
                              </div>
