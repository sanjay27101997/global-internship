...
<div className="space-y-1 px-4 sm:space-y-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 sm:py-2">
                        ...
                        <div className="sm:col-span-2">
                          <select size="7" multiple onChange={(e) =>{ value1= Array.from(e.target.selectedOptions,option =>option.value),setSchool(value1.join(','))}} id="school" name="school" className="block w-full shadow-sm sm:text-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md">
                      ...
                      <div className="space-y-1 px-4 sm:space-y-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 sm:py-2">
                        ...
                        <div className="sm:col-span-2">
                          <select
                            size="7" multiple onChange={(e) =>{ value2= Array.from(e.target.selectedOptions,option =>option.value),setClass1(value2.join(','))}}
                            value={class1}
                            id="role"
                            name="role"
                            className="block w-full shadow-sm sm:text-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md"
