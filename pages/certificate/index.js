...
export default function Assets() {
  ...
  useEffect(() => {
    axios
      .post(API_URL + "certificate/get_certificate.php", {
            ...
            <main className="py-10">
              <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8">
                <div className="flex flex-col justify-center lg:flex-row lg:justify-between lg:space-x-5">
                  <div>
                    <h1 className="text-2xl font-bold text-gray-900">Certification Questions</h1>
                  </div>
                            ...
                            {users1 ? (
                              users1.map((person) => (
                                <tr key={person?.ID}>
                                  <td className="px-6 py-4  whitespace-nowrap">
                                    <div className="flex ">
                                      <div className="ml-4 space-y-2 md:space-y-0">
                                        ...
                                        <div className="flex  md:hidden ml-7 flex-1">
                                          <span class="text-sm md:hidden font-medium">Course:</span>
                                          <div className="text-sm  text-gray-900 md:hidden ml-1 ">{person?.CourseID}</div>
                                        </div>
                                  ...
                                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 hidden md:table-cell">{person?.CourseID}</td>
