...
import AddAssetDialog from "../../components/layouts/createProgressive";
import EditAssetDialog from "../../components/layouts/editProgressive";
...
import { isUserLoggedIn, UserData ,districtsData } from "../../utils/User";
...
export default function Assets() {
  ...
  useEffect(() => {
    axios
      .post(API_URL + "progressive_quiz/get_quiz.php", {
            ...
            <main className="py-10">
              <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8">
                <div className="flex flex-col justify-center lg:flex-row lg:justify-between lg:space-x-5">
                  <div>
                    <h1 className="text-2xl font-bold text-gray-900">Progressive Questions</h1>
                  </div>
                                  ...
                                  <td className="px-6 py-4  whitespace-nowrap">
                                    <div className="flex ">
                                      <div className="ml-4 space-y-2 md:space-y-0">
                                        ...
                                        <div className="flex  md:hidden ml-7 flex-1">
                                          <span class="text-sm md:hidden font-medium">Level:</span>
                                          <div className="text-sm  text-gray-900 md:hidden ml-1 ">{person?.LevelID}</div>
                                        </div>
...
{person?.QType === "mcq" ? (
  ...
  <>
  <div className="text-sm text-gray-900">{person?.Answer}</div>
                                  ...
                                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 hidden md:table-cell">{person?.LevelID}</td>
